...
$('section').not('.carouselOverlay').toggleClass("carouselBlur");
  ...
  $(".page2X0Y1X0Y0").html(marbleLineLocationsPG2());
...
//-165 195 is sane
var APG2 = 195 * Math.PI / 180; //does this angle need units changing or coordinates changed it assumes north clockwise
...
var measureFromMarbleTopRightPG2 = 125;

  for (i = 0; i<= (W-marbleOnLineWidthPG2); i+=marbleOnLineWidthPG2){
    xForMarblePG2 = i;
